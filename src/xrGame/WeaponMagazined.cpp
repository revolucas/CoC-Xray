...
//-Alundaio
	...
	CGameObject	*object = smart_cast<CGameObject*>(H_Parent());
	if (object)
		object->callback(GameObject::eOnWeaponFired)(object->lua_game_object(), this->lua_game_object(), m_ammoElapsed.type1, m_ammoElapsed.type2, m_ammoType.type1,m_ammoType.type2);
#endif
}
